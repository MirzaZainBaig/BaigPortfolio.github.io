      ...
      <div className="p-6 w-full flex flex-col md:flex-row justify-between gap-4 md:gap-10 lgl:gap-20">
        <div className="w-full lgl:w-full">
          ...
          <p className="flex justify-between w-full text-lg text-[#ccc] py-4 border-b-[1px] border-b-zinc-800">
            <span className="bg-designColor text-gray-700 text-sm font-titleFont font-medium p-1  mr-2 rounded-md flex items-center justify-center">
              Phone:
            </span>
            +92 3249785962
          </p>
        ...
        {seuccessMsg ? (
          ...
          >
            ...
            <textarea
              ...
              placeholder="Let's connect on social media for now since this form isn't currently functional."
              rows="4"
            ></textarea>
            <button 
              id="contact"
              className="text-base w-full flex items-center gap-1 text-gray-200 hover:text-designColor duration-200"
            >
              Send Message{" "}
